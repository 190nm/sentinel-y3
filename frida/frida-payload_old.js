...
var magic = {
  "bool System_IO_File__Exists (Il2CppObject* __this, System_String_o* path, const MethodInfo* method);": 22587208,
  "System_String_o* System_IO_File__ReadAllText (Il2CppObject* __this, System_String_o* path, const MethodInfo* method);": 22589420,
  "System_String_o* System_IO_File__ReadAllText (Il2CppObject* __this, System_String_o* path, System_Text_Encoding_o* encoding, const MethodInfo* method);": 22589536,
  "System_String_o* UnityEngine_Application__get_persistentDataPath (Il2CppObject* __this, const MethodInfo* method);": 24486896,
  "void UnityEngine_Debug__Log (Il2CppObject* __this, Il2CppObject* message, const MethodInfo* method);": 24451628,
  "void UnityEngine_Debug__Log (Il2CppObject* __this, Il2CppObject* message, UnityEngine_Object_o* context, const MethodInfo* method);": 24518216,
  "void UnityEngine_Debug__LogError (Il2CppObject* __this, Il2CppObject* message, const MethodInfo* method);": 24518696,
  "void UnityEngine_Debug__LogError (Il2CppObject* __this, Il2CppObject* message, UnityEngine_Object_o* context, const MethodInfo* method);": 24518920,
  "System_String_o* Y3_Data_MasterDataStore__MakeCacheFileName (Il2CppObject* __this, System_String_o* base_db_name, const MethodInfo* method);": 11291988,
  "System_String_o* Y3_ScenarioPrivateResourceManager__GetScenarioText (Y3_ScenarioPrivateResourceManager_o* __this, System_String_o* path, const MethodInfo* method);": 13013468,
  "void Y3_Utils_IOUtil__NativeLog (Il2CppObject* __this, System_String_o* log, const MethodInfo* method);": 13500396,
  "void Y3_Data_SqlDataStore___ctor (Y3_Data_SqlDataStore_o* __this, System_String_o* databasePath, const MethodInfo* method);": 11667704,
  "void SQLite4Unity3d_SQLiteConnection___ctor (SQLite4Unity3d_SQLiteConnection_o* __this, System_String_o* databasePath, bool storeDateTimeAsTicks, const MethodInfo* method);": 13201696,
  "void SQLite4Unity3d_SQLiteConnection___ctor (SQLite4Unity3d_SQLiteConnection_o* __this, System_String_o* databasePath, int32_t openFlags, bool storeDateTimeAsTicks, const MethodInfo* method);": 13201708,
  "int32_t SQLite4Unity3d_SQLiteConnection__Execute (SQLite4Unity3d_SQLiteConnection_o* __this, System_String_o* query, System_Object_array* args, const MethodInfo* method);": 13209424,
  "void biscuit_Scenario_UI_WindowTextView__SetText (biscuit_Scenario_UI_WindowTextView_o* __this, System_String_o* text, System_Action_o* onComplete, System_Action_o* onFinish, biscuit_Scenario_Common_VoiceData_o* voice, const MethodInfo* method);": 13857868
}
...
function hook() {
  ...
  let logfuncs_3_args = [$IOUtil__NativeLog, $Debug__Log, $Debug__LogError];
  let logfuncs_4_args = [$Debug__Log2, $Debug__LogError2];

  for (const logfunc of logfuncs_3_args){
    Interceptor.replace(logfunc,
      new NativeCallback(
  ...
  for (const logfunc of logfuncs_4_args){
    Interceptor.replace(logfunc,
      new NativeCallback(
        function (this_il2cpp_o, log_o, context_o, method_o){console.log(log_o.add(0x14).readUtf16String())},
        'void',
  ...
  //   )
  // );
  // // sql queries for "patching" masterdata
  // var QUERY = 
  // 'UPDATE cards\n \
  ...
  // // Injects sql query to individual databases as they're called. The entire masterdata pipeline is spaghetti so this gets
  // // called once for every *table* in each database. No, im not joking, its seriously that bad.
  // // TODO: rewrite to reduce overhead by "patching" the databases right after they're decrypted to temp files, but before they're read
  ...
  // Variables to adjust for readability with english
  // var FONTSIZE = 38;
